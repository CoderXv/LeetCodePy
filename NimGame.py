...
# ------------------Solution In brief-----------------------
"""
	Each time we can take 1, 2, 3 stones, 
	so if the number of stones in the heap can be divided by 4, 
	we'll always lose the game. if not, there's always a strategy that 
	we can win.
"""
